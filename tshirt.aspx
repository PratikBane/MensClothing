          ...
          <button class="navbar-toggle" type="button" data-toggle="collapse" data-target="#navbarResponsive" > 
            ...
            <div class="collapse navbar-collapse navbar-right" id="navbarResponsive">
                <ul class="nav navbar-nav ">
                    ...
                    <li class="nav nav-tabs active "><a  href="T-Shirts.aspx">T-Shirts</a></li>
     ...
     <br />
            <br />
             ...
             <div class="container02">
                ...
                <tr>
                    <td class="text-center"  >
                        <span style="color:#FF6600; font-size: 15px;" class="fas fa-rupee-sign">&nbsp;</span><asp:Label ID="Label3" runat="server" ForeColor="#FF6600" Text='<%# Eval("price") %>' Font-Size="20px"></asp:Label>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="text-center">
                        <br />
                        <asp:Button runat="server" ID="remove" CssClass="btn btn-primary" Text="Remove from cart" Visible="false" />  
                    </td>
                </tr>
            </table>
                        </ItemTemplate>
           ...
           <br />
             ...
             <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ProductsConnectionString %>" SelectCommand="SELECT * FROM [t_shirts]"></asp:SqlDataSource>
