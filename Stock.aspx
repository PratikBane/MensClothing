            ...
            <table class="nav-justified table-responsive container01 table-bordered table-condensed">
                 ...
                 <tr style="color:black">
                            <td class="text-center" style="color:black" colspan="14">
                               <em style="color:red">* </em> <asp:Label ID="Label1" ForeColor="Black" runat="server" Text="Search by Product Id"></asp:Label> <em style="color:red">* </em>
                                <br />
                            ...
                            <th class="text-center" style="color:black"> Product Id</th>
                             <th class="text-center" style="color:black">S</th>
                            <th class="text-center" style="color:black">M</th>
                            <th class="text-center" style="color:black">L</th>
                            <th class="text-center" style="color:black">XL</th>
                                </tr>
                     <asp:Repeater ID="Repeater1" runat="server" >
                        <ItemTemplate>
                            ...
                            <td data-col-title=" Product Id:" class="text-center" style="color:black">
                                <asp:Label ID="Label2" ForeColor="#333333" runat="server" Text='<%# Eval("productid") %>'></asp:Label>
                            </td>

                            <td data-col-title="S:" class="text-center" style="color:black">
                                <asp:Label ID="lbl_pid" ForeColor="#333333" runat="server" Text='<%# Eval("s") %>' ></asp:Label>
                            </td>

                            <td data-col-title="M:" class="text-center" style="color:black">
                                <asp:Label ID="lbl_adddress" ForeColor="#333333" runat="server" Text='<%# Eval("m") %>'/>
                            </td>

                            <td data-col-title="L:" class="text-center" style="color:black">
                                <asp:Label ID="lbl_size" ForeColor="#333333" runat="server" Text='<%# Eval("l") %>' ></asp:Label>
                            </td>

                                <td data-col-title="XL:" class="text-center" style="color:black">
                                <asp:Label ID="Label3" ForeColor="#333333" runat="server" Text='<%# Eval("xl") %>' ></asp:Label>
                            </td>
                        </tr>
